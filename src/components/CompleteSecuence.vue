<template>
  <v-card>
    ...
    <v-container fluid style="height: 80vh; overflow: auto;">
      <v-row
        :class="$vuetify.breakpoint.mdAndDown ? 'pa-0' : 'fill-height pa-0'"
        no-gutters
        align="center"
        justify="center"
      >
        ...
        <v-col
          v-show="!endQuestions"
          cols="12"
          class="py-md-6 px--md-0 mx-auto"
        >
          <v-row no-gutters align="center" justify="end">
            <v-col v-for="(value, index) in arraySecuence" :key="index">
              <v-container
                :class="
                  $vuetify.breakpoint.mdAndDown ? 'pa-0' : 'fill-height pa-0'
                "
                fluid
              >
                    ...
                    <v-row align="start" justify="center">
                      <v-col style="position: relative;">
                        ...
                        <div
                          v-else
                          :class="
                            $vuetify.breakpoint.mdAndDown ? 'boxMobile' : 'box'
                          "
                        >
                          <template>
                            <v-container
                        ...
                        <v-sheet
                          ...
                          v-show="dialog"
                          :width="
                            $vuetify.breakpoint.mdAndDown ? '100%' : '200px'
                          "
                          :class="
                            $vuetify.breakpoint.mdAndDown
                              ? ''
